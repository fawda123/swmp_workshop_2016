...
2) Install RStudio v0.99.903 (or later): <a href="http://swmprats.net/workshop-2014/images/documents/R_install_guide.pdf" target="_parent">Instructions</a> (page 5 - 6)
...
* Supplementary R resources: <a href="images/intro_to_R.pdf" target="_parent">Introduction</a>,  <a href="images/R_for_data_analysis.pdf" target="_parent">R for data danalysis</a>

* SWMPr: <a href="https://journal.r-project.org/archive/2016-1/beck.pdf" target = "_parent">manuscript</a>

* Weighted regression in tidal waters with WRTDStidal: <a href="images/Beck-and-Hagy-2015-weighted-regression-for-tidal-waters.pdf" target = "_parent">manuscript</a>, <a href="https://github.com/fawda123/WRTDStidal" target = "_parent">website</a>
